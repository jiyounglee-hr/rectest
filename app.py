...
- 최대 5개 이내의 항목으로 간결하게 정리해주세요."""},
    ...
    st.markdown("""
    1. 면접관 사전 미팅
       - 면접 시작 10분 전 면접 진행 방식에 대해 의견을 조율합니다.

    2. 면접시작
       - 입장하는 면접자들에게 가볍게 인사(바로 면접 본 질문으로 들어가지 않고 가벼운 환영 인사로 편안한 분위기를 유도)
       - '식사는 하셨나요?', '오시는 데 불편하진 않으셨나요?', '많이 긴장 되시죠? 편안하게 생각하세요!'
       - 면접관의 소속과 직책 등을 소개합니다.
       - 채용 직무와 면접 진행 방식에 대해서도 간단히 설명해주는 것이 좋습니다.

    3. 지원자 자기소개
       - 지원자에게 경력 위주로 자기소개를 부탁합니다.
       - 지원자가 자기소개를 하는 동안 가급적 eye-contact를 해 주면서 부드러운 표정으로 경청합니다.

    4. 자기소개 관련 질문
       - 지원자의 자기소개 내용 중 궁금한 사항에 대해 질문합니다.
       - 입사지원서 자기 소개란의 기재사항 중 궁금한 사항을 질문합니다.

    5. 직무역량/적성 관련질문
       - 입사지원서 상의 경력, 교육 이수사항, 자격사항, 전공 등을 참고하여 직무와 관련된 질문을 합니다.
       - 면접평가표에 기재된 지식/기술/태도에 대한 기준을 참고하면서 면접자를 평가합니다.

    6. 입사관련사항 확인
       - 입사 가능일을 확인합니다. (연봉 관련은 2차면접에서 확인/협의합니다.)
       - 마지막으로 지원자가 궁금한 사항이 있으면 답변을 해줍니다.

    7. 면접 종료
       - 다음 일정을 간단히 설명해 줍니다. (1차 면접 결정 및 2차 면접이 있음을 인지)
       - 면접 종료 인사와 따뜻한 격려의 말을 건넵니다.
       - '장시간 동안 면접 보시느라 고생 많았습니다.' '좋은 결과 있길 바라겠습니다. 수고하셨습니다.' 등

    8. 면접평가
       - 면접자별 면접 평가서 작성 및 피드백을 작성한 후 인사팀에 전달합니다.
    """)
