...
- 이력서와 채용공고의 연결고리를 고려해 질문을 구성하세요."""},
    ...
    st.markdown("""
     면접 시 절대 하지 말아야 하는 질문 
    면접 시 직무와 무관한 질문은 자제해 주시기 바랍니다. 
    구직자의 신체적 조건 : “생각보다 작아 보이는데 키가 얼마나 되시나요?” “체격이 좋네요. 어렸을 때 운동하셨나요?” 
    구직자의 출신지역ㆍ혼인여부ㆍ재산 관련 질문 : “사투리 쓰시네요? 어디 출신이에요?” “결혼하셨어요? 언제 하셨는데요?” “아이가 있으신가요? 혹시 낳으실 계획이라면 언제쯤으로 생각하세요?” “현재 만나는 사람이 없으신가요?”
    구직자 가족의 학력ㆍ직업 : “부모님은 무슨 일을 하시죠?” “부모님은 무슨 일을 하시죠?”
    그 외 인격모독적이거나 채용에 직접 관련된 질문 : “내가 뽑아주면 뭘 해 줄 수 있나요?” “그동안 뭐 했길래 경력이 이거 밖에 안 돼요?” “영~ 일 못할 것 같은데... 할 수 있겠어요?”
    담배 피시나요? : “담배 피시나요?”
