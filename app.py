...
- 이력서와 채용공고의 연결고리를 고려해 질문을 구성하세요."""},
    ...
    신체적 조건 : “생각보다 작아 보이는데 키가 얼마나 되시나요?” “체격이 좋네요. 어렸을 때 운동하셨나요?” 
                
    출신지역ㆍ혼인여부ㆍ재산 관련 질문 : “사투리 쓰시네요? 어디 출신이에요?” “결혼하셨어요? 언제 하셨는데요?” “아이가 있으신가요? 혹시 낳으실 계획이라면 언제쯤으로 생각하세요?” “현재 만나는 사람이 없으신가요?”
    
    가족의 학력ㆍ직업 : “부모님은 무슨 일을 하시죠?” “부모님은 무슨 일을 하시죠?”
