...
def generate_questions(resume_text, job_description):
    try:
        ...
        [경력 기반 질문] (2개)
        1. 가장 중요한 프로젝트 경험에 대한 질문
        2. 어려운 문제를 해결한 구체적 사례에 대한 질문
        ...
        7. [도전] "두려워 말고 시도합니다"와 관련된 경험을 묻는 질문
        8. [책임감] "대충은 없습니다"와 관련된 사례를 묻는 질문
        9. [협력] "동료와 협업합니다"와 관련된 경험을 묻는 질문
        10. [전문성] "능동적으로 일합니다"와 관련된 사례를 묻는 질문

        [성장 가능성 질문] (1개)
        11. 자기 개발 계획과 비전에 대한 질문
